...
__export(index_exports, {
  ...
  IntellectMemoryClient: () => IntellectMemoryClient,
  IntellectMemoryError: () => IntellectMemoryError,
...
var IntellectMemoryClient = class {
  ...
  async createMemory(data) {
    return this.request("POST", "/v1/memories", data);
  }
  /**
   * Get a memory by ID
   */
  ...
  async updateMemory(id, data) {
    return this.request("PUT", `/v1/memories/${id}`, data);
  }
  /**
   * Delete a memory
   */
